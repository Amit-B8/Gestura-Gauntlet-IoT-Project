...
const telemetryService = new TelemetryService({ persistence, telemetrySink: influxTelemetrySink, deviceRegistry });
const routeMetricsService = new RouteMetricsService({ persistence, telemetryService, deviceRegistry });
